---
title: "Mapped Type: 매핑된 타입"
date: "240806"
tags: ["TypeScript"]
---

매핑된 타입(Mapped Type)은 기존 타입을 기반으로 새로운 타입을 생성할 수 있게 해주는 TS의 강력한 기능입니다.
...
매핑된 타입은 강력하지만, 복잡한 타입을 다룰 때는 TypeScript 컴파일러의 성능에 영향을 줄 수 있습니다. 특히 깊은 중첩이나 복잡한 조건부 타입과 결합될 때 주의가 필요합니다.
